...
export const TwitterAccounts = [
  ...
  {
    consumer_key: process.env.CONSUMER_KEY_ACCOUNT_3 as string,
...
export const DISCORD_UNIXPUNKS_CHANNEL_ID =
  process.env.DISCORD_UNIXPUNKS_CHANNEL_ID;
export const DISCORD_EDEN_PROPERTIES_CHANNEL_ID =
  process.env.DISCORD_EDEN_PROPERTIES_CHANNEL_ID;
...
export const CoinmarketcapPriceConversionUrl = process.env
  .COINMARKETCAP_PRICE_CONVERSION_URL as string;

export const CollectionName =
  (process.env.COLLECTION_NAME as string) ||
  "XPUNKS, EDEN-PROPERTIES, UNIXPUNKS";
